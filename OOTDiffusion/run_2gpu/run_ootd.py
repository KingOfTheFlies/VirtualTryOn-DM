...
parser.add_argument('--unet_path', type=str, default="", required=True)
...
if model_type == "hd":
    model = OOTDiffusionHD(args.gpu_id, args.unet_path)
elif model_type == "dc":
...
if __name__ == '__main__':
    ...
    image_idx = 0
    for image in images:
        image.save('./images_output/out_' + model_type + '_' + args.unet_path[-4:] + '_' + str(image_idx) + '.png')
        image_idx += 1
