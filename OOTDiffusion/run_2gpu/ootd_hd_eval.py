...
def get_opt():
    ...
    parser.add_argument(
        "--weights_folder_name", type=str, default='./ootd_output_results', help="dir of saved checkpoints"
    )
...
weights_folder_name = opt.weights_folder_name
VIT_PATH = "VIT_PATH"
VAE_PATH = "VAE_PATH"
MODEL_PATH = "MODEL_PATH"
scheduler_path = 'scheduler_path'
UNET_PATH = "UNET_PATH" + weights_folder_name
